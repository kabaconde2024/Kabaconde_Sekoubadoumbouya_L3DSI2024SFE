...
const { creerFormation, getAllSessionsForFormation,afficherFormation,Afficher,updateFormation,deleteFormationById,afficher,afficherFormations,accepterFormation,accepterSession,formationsByFormateur,recupererSessionsFormation} = require('../controller/adminformation');
...
router.get('/getAllSessionsForFormation/:id', getAllSessionsForFormation);
