...
const { creerSession,NombreInscrit,mettreAJourMontantRestant, sessionsFormateur,updateSessionPrice,afficherSessions, updateSession, deleteSessionById,afficherDetailsSession } = require('../controller/SessionController');
...
router.put('/mettreAJourMontantRestant/:sessionId', mettreAJourMontantRestant);
