...
const { creerSession,getSessionById, sessionsFormateur,updateSessionPrice,afficherSessions, updateSession, deleteSessionById,afficherDetailsSession } = require('../controller/SessionController');
